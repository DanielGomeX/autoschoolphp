...
<h6 class="mb-4"><i>NOVA CONTA</i></h6><hr>
<form method="POST" action="{{route('pagar.insert')}}">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input value="<?php echo date('Y-m-d') ?>" type="date" class="form-control" id="data_venc" name="data_venc">
                </div>
            </div>
        </div>
