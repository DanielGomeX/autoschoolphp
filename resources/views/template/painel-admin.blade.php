    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('horarios.index')}}">Horários</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
                ...
                <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="" data-toggle="modal" data-target="#relServ">Serviços</a>
                        <a class="collapse-item" href="" data-toggle="modal" data-target="#relAulas">Aulas</a>
                    </div>
                </div>
            </li>
...
<!-- Modal Rel Aulas -->
<div class="modal fade" id="relAulas" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-inline" method="GET" action="{{route('rel.aulas')}}" target="_blank">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
...
<!-- Modal Rel Serv-->
<div class="modal fade" id="relServ" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Selecionar Datas - Relatório de Serviços</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form class="form-inline" method="GET" action="{{route('rel.servicos')}}" target="_blank">
                        @csrf
                        <div class="row">
                                <input value="{{$hoje}}" class="form-control form-control-sm ml-2 mr-1" name="dataInicial" type="date">
                                <input value="{{$hoje}}" class="form-control form-control-sm ml-2 mr-1" name="dataFinal" type="date">
