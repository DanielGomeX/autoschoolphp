...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('painel-instrutor.index')}}">

                <div class="sidebar-brand-text mx-3">Instrutor</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('servicos.index')}}">
                    <i class="fas fa-taxi fa-chart-area"></i>
                    <span>Serviços</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="{{route('marcacoes.index')}}">
        ...
        <!-- Nav Item - Charts -->
        <li class="nav-item">
            <a class="nav-link" href="{{route('comissoes.index')}}">
        ...
        <li class="nav-item">
                ...
                <div id="collapseUtilities2" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    ...
                    <a class="collapse-item" href="" data-toggle="modal" data-target="#relMov">Comissões</a>
...
<div class="modal fade" id="relMov" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-inline" method="GET" action="{{route('rel.comissoes')}}" target="_blank">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
